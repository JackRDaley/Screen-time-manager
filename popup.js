...
const CHROME_WEBSTORE_REVIEW_URL =
  "https://chromewebstore.google.com/detail/screen-time-manager/pecaajdaecdmikcgfdgldcofdebhfbgo/reviews";
    ...
    rankingRows(sortByVisits, range)
      .map(([domain, entry], index) => {
        ...
        const quickAction = cfg
          ? `<span class="quick-limit-chip is-limited">Limited</span>`
